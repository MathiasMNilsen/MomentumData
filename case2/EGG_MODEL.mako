...
INCLUDE
${"\'../ensemble/PERM{}_ECL.INC\' /".format(sample_index)}
...
%for p in range(10):  
${"WCONINJE"}
${"INJECT1 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+0])}
${"INJECT2 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+1])}
${"INJECT3 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+2])}
${"INJECT4 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+3])}
${"INJECT5 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+4])}
${"INJECT6 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+5])}
${"INJECT7 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+6])}
${"INJECT8 WATER OPEN RATE {} 1* 420.0  /".format(injrate[8*p+7])}
${"/"}

${"WCONPROD"}
${"PROD1 OPEN LRAT 3* {} /".format(prodrate[4*p+0])}
${"PROD2 OPEN LRAT 3* {} /".format(prodrate[4*p+1])}
${"PROD3 OPEN LRAT 3* {} /".format(prodrate[4*p+2])}
${"PROD4 OPEN LRAT 3* {} /".format(prodrate[4*p+3])}
${"/"}
